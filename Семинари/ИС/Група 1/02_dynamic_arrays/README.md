...
Дефинирайте шаблонна функция `std::vector<T> union(const std::vector<T>& first, const std::vector<T>& second)`, която връща нов динамичен масив, съдържащ обединението на елементите на подадени два динамични масива, без да има повторение.
